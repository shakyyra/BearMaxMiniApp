...
interface MentoringBannerProps {
  onDetailsClick?: () => void;
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-white w-full">
      <div className="font-['Plus_Jakarta_Sans:Bold','Noto_Sans:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[20px] w-full">
        <p className="leading-[normal] mb-0">{`Кто такой `}</p>
        <p className="leading-[normal]">
          <span className="font-['Plus_Jakarta_Sans:Bold','Noto_Sans:Bold',sans-serif] font-bold">наставник</span>?
        </p>
      </div>
      <p className="font-['Plus_Jakarta_Sans:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[13px] w-full">Детям не хватает своего взрослого и поддержки</p>
    </div>
  );
}
...
export function MentoringBanner({ onDetailsClick }: MentoringBannerProps) {
  return (
