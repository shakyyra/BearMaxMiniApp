...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-white w-full">
      <p className="font-['Plus_Jakarta_Sans:Bold','Noto_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[20px] w-full">Зачем проводить мастер-классы?</p>
      <p className="font-['Plus_Jakarta_Sans:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[13px] w-full">Путь к делу начинается с первой попытки</p>
    </div>
  );
}
...
export function MasterclassBanner({ onDetailsClick }: MasterclassBannerProps) {
  return (
