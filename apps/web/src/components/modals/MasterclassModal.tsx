...
import imgImage3 from "@/assets/masterclass-illustration.png";
...
export function MasterclassModal({ isOpen, onClose }: MasterclassModalProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="h-[225px] relative rounded-[20px] shrink-0 w-full max-w-[338px]" data-name="image 3">
              <img 
                alt="Мастер-класс" 
            ...
            <div className="font-['Plus_Jakarta_Sans:Medium','Noto_Sans:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[#4b4b4b] text-[16px] w-full max-w-[330px]">
              <p className="mb-0">Дети в детдомах редко пробуют себя в настоящих профессиях и хобби. Всего одно занятие может открыть новый мир и увлечение.</p>
              <p>Передайте свой навык! Расскажите, какой мастер-класс вы готовы провести.</p>
            </div>
            <motion.button
              ...
              <div className="flex flex-row items-center justify-center size-full">
                <div className="box-border content-stretch flex gap-[10px] h-[55px] items-center justify-center p-[8px] relative w-full">
                  <div className="basis-0 flex flex-col font-['Plus_Jakarta_Sans:Bold','Noto_Sans:Bold',sans-serif] font-bold grow h-[33px] justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[20px] text-center text-white">
                    <p className="leading-[normal]">Рассказать</p>
                  </div>
                </div>
              </div>
            </motion.button>
